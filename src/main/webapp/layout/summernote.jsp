				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu dropend">
							<li><a class="dropdown-item dropdown-toggle" role="button">１９９０年代</a>
								<ul class="dropdown-menu submenu">
									<li><a href="/album/japan?year=1990&gen=boy" class="dropdown-item text-center">BoyGroup</a></li>
									<li><a href="/album/japan?year=1990&gen=girl" class="dropdown-item text-center">GirlGroup</a></li>
								</ul>
							</li>
							<li><hr class="dropdown-divider"></li>
							<li><a class="dropdown-item dropdown-toggle" role="button">２０００年代</a>
