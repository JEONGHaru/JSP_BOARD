...
<body>
	...
	<div class="container">
		<div class="row mt-4">
			<div class="col-sm-5">
				<div class="fs-1"><img src="image/korea.png" alt="" />韓アイドル</div>
				<div id="carouselExampleSlidesOnly" class="carousel slide"
					...
					<div class="carousel-inner border p-2">
						...
						<div class="carousel-item">
							<img src="image/lesserafim.jpeg" class="d-block w-100 lesse" alt="...">
						</div>
			...
			<div class="fs-1"><img src="image/japan.png" alt="" />日アイドル</div>
		
				<div id="carouselExampleSlidesOnly" class="carousel slide"
					data-bs-ride="carousel">
					<div class="carousel-inner badge border p-2">
						<div class="carousel-item active"data-bs-interval="2000">
							<img src="image/nogizaka.png" class="d-block w-100 nogi" alt="...">
						</div>
						<div class="carousel-item">
