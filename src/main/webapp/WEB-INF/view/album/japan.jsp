		...
		<div class="section-content">
			<div class="container services">
				<div class="services-header text-center py-5">
					...
					<form class="row" action="japan/upload?year=${years}&gen=${gender}" method="POST"
...
<div class="container-fulid">
	<div class="row justify-content-center">
		<c:forEach var="n" items="${list}" varStatus="vs">
			...
			<div class="modal modal-lg fade" id="exampleModal${vs.index }" tabindex="-1"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body"><img src="${n.filePath }" class="card-img-top"></div>
