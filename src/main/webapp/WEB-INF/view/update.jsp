...
<nav class="navbar navbar-expand-lg bg-light">
	...
	<div class="container">
		<div class="row">
			<form action="update?bbsID=${bbs.id}" method="post" onsubmit="joinFormSubmit(this); return false;">
			<table class="table table-striped" style="text-align:center; border:#dddddd">
				...
				<tbody>
					<tr>
						...
						maxlength="50" value="${bbs.title}" /></td>
					</tr>
					<tr>	
						<td><textarea class="form-control" placeholder="内容" name="content"
						maxlength="2048" style="height:350px;" >${bbs.content }</textarea></td>
					</tr>
				</tbody>
			</table>
